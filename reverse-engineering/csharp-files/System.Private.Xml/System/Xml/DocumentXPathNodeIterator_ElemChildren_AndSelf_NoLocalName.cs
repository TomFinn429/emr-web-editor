...
{
	internal DocumentXPathNodeIterator_ElemChildren_AndSelf_NoLocalName(DocumentXPathNavigator P_0, string P_1)
		: base(P_0, P_1)
	{
	}

	internal DocumentXPathNodeIterator_ElemChildren_AndSelf_NoLocalName(DocumentXPathNodeIterator_ElemChildren_AndSelf_NoLocalName P_0)
		: base(P_0)
	{
	}
