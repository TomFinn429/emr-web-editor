...
internal static class KnownHeaders
{
	...
	private readonly struct StringAccessor : IHeaderNameAccessor
	{
		...
		public char this[int P_0] => _string[P_0];

		public StringAccessor(string P_0)
		{
			_string = P_0;
		}
	}
	...
	private static KnownHeader GetCandidate<T>(T P_0) where T : struct, IHeaderNameAccessor
	{
		switch (P_0.Length)
		{
		case 2:
	...
	internal static KnownHeader TryGetKnownHeader(string P_0)
	{
		KnownHeader candidate = GetCandidate(new StringAccessor(P_0));
		if (candidate != null && StringComparer.OrdinalIgnoreCase.Equals(P_0, candidate.Name))
		{
			return candidate;
		}
		return null;
	...
	static KnownHeaders()
	{
		string[] obj = new string[1] { "true" };
		int? num = 73;
		AccessControlAllowCredentials = new KnownHeader("Access-Control-Allow-Credentials", HttpHeaderType.Response, null, obj, null, num);
		string[] obj2 = new string[1] { "*" };
		num = 33;
		AccessControlAllowHeaders = new KnownHeader("Access-Control-Allow-Headers", HttpHeaderType.Response, null, obj2, null, num);
		string[] obj3 = new string[1] { "*" };
		num = 76;
		AccessControlAllowMethods = new KnownHeader("Access-Control-Allow-Methods", HttpHeaderType.Response, null, obj3, null, num);
		...
		num = 83;
		AltSvc = new KnownHeader("Alt-Svc", HttpHeaderType.Response, null, null, null, num);
		...
		num = 85;
		ContentSecurityPolicy = new KnownHeader("Content-Security-Policy", null, num);
		...
		Cookie = new KnownHeader("Cookie", HttpHeaderType.Custom, CookieHeaderParser.Parser, null, 32, 5);
		...
		num = 90;
		Origin = new KnownHeader("Origin", null, num);
		...
		string[] obj4 = new string[1] { "1" };
		num = 94;
		UpgradeInsecureRequests = new KnownHeader("Upgrade-Insecure-Requests", HttpHeaderType.Custom, null, obj4, null, num);
		...
		string[] obj5 = new string[1] { "nosniff" };
		num = 61;
		XContentTypeOptions = new KnownHeader("X-Content-Type-Options", HttpHeaderType.Custom, null, obj5, null, num);
		string[] obj6 = new string[2] { "DENY", "SAMEORIGIN" };
		num = 97;
		XFrameOptions = new KnownHeader("X-Frame-Options", HttpHeaderType.Custom, null, obj6, null, num);
