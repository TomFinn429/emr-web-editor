...
internal sealed class HuffmanTree
{
	...
	public HuffmanTree(byte[] P_0)
	{
		_codeLengthArray = P_0;
	...
	private static uint BitReverse(uint P_0, int P_1)
	{
		uint num = 0u;
		do
		{
	...
	public int GetNextSymbol(InputBuffer P_0)
	{
		uint num = P_0.TryLoad16Bits();
		if (P_0.AvailableBits == 0)
		{
			return -1;
		}
