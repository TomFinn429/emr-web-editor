...
export let WriterControl_DialogStaticResources = {
    VERSIONTYPE: "t", //临时版:t,周版本:w,月版本: m
    ISSIMPLIFIED: false, //是否精简版本  true:精简版, false:完整版(默认)
    //对话框的样式
    DIALOGSTYLE: `
#dc_dialogMark {
    width: 100%;
...
#dc_dialogContainer input[type=radio]{
    border-radius: 50%;
    margin-right: 6px;
}

#dc_dialogContainer input[type="radio"]:checked::after {
    content: "";
    display: block;
    position: relative;
    top: calc(50% - 4px);
...
#dcPanelBody.CheckboxAndRadio .form-section {
    margin-bottom: 6px;
}

#dcPanelBody.CheckboxAndRadio .form-section:last-of-type {
    margin-bottom: 0;
}

#dcPanelBody.CheckboxAndRadio .form-row {
    display: flex;
    align-items: center;
    margin-bottom: 10px;
    gap: 10px;
...
#dcPanelBody.CheckboxAndRadio .form-group .form-row {
    margin-bottom: 4px;
}

#dcPanelBody.CheckboxAndRadio .form-group .form-row:last-child {
    margin-bottom: 0;
}

#dcPanelBody.CheckboxAndRadio .form-row:last-child {
    margin-bottom: 0;
}

#dcPanelBody.CheckboxAndRadio .form-label {
    min-width: 90px;
    font-size: 12px;
    color: #000;
    text-align: right;
...
#dcPanelBody.CheckboxAndRadio .form-input {
    flex: 1;
    padding: 4px 8px;
...
#dcPanelBody.CheckboxAndRadio .form-input:focus {
    outline: none;
    border-color: #0078d4;
}

#dcPanelBody.CheckboxAndRadio .form-input.error {
    border-color: #d32f2f;
}

#dcPanelBody.CheckboxAndRadio .dc-error-tip {
    color: #d32f2f;
    font-size: 11px;
    margin-top: 2px;
}

#dcPanelBody.CheckboxAndRadio .form-select {
    flex: 1;
    padding: 4px 8px;
    border: 1px solid #ccc;
    border-radius: 3px;
...
#dcPanelBody.CheckboxAndRadio .form-select:focus {
    outline: none;
    border-color: #0078d4;
}

#dcPanelBody.CheckboxAndRadio .form-checkbox {
    width: 14px;
    height: 14px;
    accent-color: #0078d4;
    cursor: pointer;
...
#dcPanelBody.CheckboxAndRadio .checkbox-grid {
    display: grid;
...
#dcPanelBody.CheckboxAndRadio .checkbox-item {
    display: flex;
    align-items: center;
    gap: 6px;
}

#dcPanelBody.CheckboxAndRadio .checkbox-label {
    font-size: 12px;
    color: #000;
    cursor: pointer;
    user-select: none;
...
#dcPanelBody.CheckboxAndRadio .section-title {
    font-size: 13px;
    font-weight: 500;
    color: #000;
    margin: 0 0 6px 0;
...
#dcPanelBody.CheckboxAndRadio .form-group {
...
#dcPanelBody.CheckboxAndRadio .data-section {
    margin-top: 6px;
    padding-top: 6px;
}

#dcPanelBody.CheckboxAndRadio .data-section .form-group {
    margin-top: 6px;
    margin-bottom: 0;
}

#dcPanelBody.CheckboxAndRadio .example-btn {
    background-color: #f0f0f0;
    color: #000;
    border: 1px solid #ccc;
    padding: 4px 12px;
...
#dcPanelBody.CheckboxAndRadio .example-btn:hover {
    background-color: #e6e6e6;
}

#dcPanelBody.CheckboxAndRadio .required-mark {
    color: #d32f2f;
}

/* 数据源信息组件样式 */
#dcPanelBody.CheckboxAndRadio #dc_datasource_container {
    padding: 0;
    background-color: transparent;
    border: none;
}

#dcPanelBody.CheckboxAndRadio #dc_datasource_container > .dcBody-content {
    margin-bottom: 0;
}

#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box {
    margin: 0;
    background-color: #fafafa;
    border: 1px solid #e8e8e8;
    border-radius: 4px;
...
#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box .dc_title {
    display: none;
}

#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box > .dcBody-content {
    margin-bottom: 4px;
}

#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box > .dcBody-content:last-child {
    margin-bottom: 0;
}

#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box form {
    display: flex;
    flex-direction: column;
}

#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box form .dcBody-content {
    margin-bottom: 4px;
}

#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box form .dcBody-content:last-child {
    margin-bottom: 0;
}

#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box .dc_flex {
    display: flex;
    align-items: center;
    gap: 10px;
    margin-bottom: 0;
...
#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box .dcTitle-text {
    min-width: 60px;
    font-size: 12px;
    color: #000;
    flex-shrink: 0;
...
#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box .dc_full {
    flex: 1;
    padding: 4px 8px;
    border: 1px solid #ccc;
    border-radius: 3px;
...
#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box .dc_full:focus {
    outline: none;
    border-color: #0078d4;
}

#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box .dc_full:disabled {
    background-color: #f5f5f5;
    color: #999;
    cursor: not-allowed;
}

#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box .fullWidth {
    width: 100%;
    padding: 4px 8px;
    border: 1px solid #ccc;
    border-radius: 3px;
...
#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box .fullWidth:focus {
    outline: none;
    border-color: #0078d4;
}

#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box .fullWidth:disabled {
    background-color: #f5f5f5;
    color: #999;
    cursor: not-allowed;
}

#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box .dc_blockelement {
    display: none;
}

#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box input[type="checkbox"] {
    width: 14px;
    height: 14px;
    accent-color: #0078d4;
    cursor: pointer;
...
#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box > .dcBody-content > label {
    display: flex;
    align-items: center;
    font-size: 12px;
    color: #000;
...
#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box form .dcBody-content > label {
    display: flex;
    align-items: center;
    font-size: 12px;
    color: #000;
...
#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box form .dcBody-content > label input[type="checkbox"] {
    cursor: pointer;
}

#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box form .dcBody-content > label .dcTitle-text {
    cursor: pointer;
}

#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box select {
    cursor: pointer;
    padding: 4px 8px;
    border: 1px solid #ccc;
    border-radius: 3px;
...
#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box select:focus {
    outline: none;
    border-color: #0078d4;
}

#dcPanelBody.CheckboxAndRadio #dc_ValueBinding_Box select:disabled {
    background-color: #f5f5f5;
    color: #999;
    cursor: not-allowed;
}
...
/* 自定义属性组件样式 */
#dcPanelBody .dc_attribute_dialog_box {
    background-color: transparent;
    border: none;
    border-radius: 0;
    padding: 0;
...
#dcPanelBody .dc_attribute_dialog_title {
    display: flex;
    justify-content: flex-end;
    gap: 8px;
    margin-bottom: 8px;
...
#dcPanelBody .dc_attribute_dialog_title span {
    background-color: #f0f0f0;
    color: #000;
    border: 1px solid #ccc;
    padding: 4px 12px;
...
#dcPanelBody .dc_attribute_dialog_title span:hover {
    background-color: #e6e6e6;
}

#dcPanelBody #dc_attr-table-box {
    width: 100%;
    border-collapse: collapse;
    font-size: 12px;
    background-color: white;
...
#dcPanelBody #dc_attr-table-box th {
    background-color: #f0f0f0;
    border: 1px solid #ccc;
    padding: 8px 6px;
    text-align: center;
...
#dcPanelBody #dc_attr-table-box td {
    border: 1px solid #ccc;
    padding: 4px 6px;
    text-align: center;
}

#dcPanelBody #dc_attr-table-box td.dc_delete-button {
    cursor: pointer;
    color: #666;
    font-size: 12px;
    transition: all 0.2s;
...
#dcPanelBody #dc_attr-table-box td.dc_delete-button:hover {
    background-color: #ffebee;
    color: #d32f2f;
}

#dcPanelBody #dc_attr-table-box input {
    width: 100%;
    border: none;
    font-size: 12px;
...
#dcPanelBody #dc_attr-table-box input:focus {
    background-color: #f0f8ff;
    outline: 1px solid #0078d4;
}

#dcPanelBody .dc_ons-2 {
    width: 40%;
}

#dcPanelBody .dc_ons-3 {
    width: 45%;
}

#dcPanelBody .dc_ons-4 {
    width: 15%;
}
...
/* 插入单复选框样式 */
/* 表单区块样式 */
#dcPanelBody.InsertMultipleCheckBoxOrRadio .dcBody-content {
    margin-bottom: 6px;
}

#dcPanelBody.InsertMultipleCheckBoxOrRadio .dcBody-content:last-of-type {
    margin-bottom: 0;
}

/* 表单行样式 */
#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc_flex {
    display: flex;
    align-items: center;
    gap: 10px;
    margin-bottom: 0;
}
#dc_dialogContainer #dcPanelBody.InsertMultipleCheckBoxOrRadio .dcTitle-text{
    margin-bottom: 0;
}

#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc_flex:last-child {
    margin-bottom: 0;
}

/* 标签样式 */
#dcPanelBody.InsertMultipleCheckBoxOrRadio .dcTitle-text {
    min-width: 90px;
    font-size: 12px;
    color: #000;
    text-align: right;
...
/* 输入框样式 */
#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc_full {
    flex: 1;
    padding: 4px 8px;
    border: 1px solid #ccc;
    border-radius: 3px;
...
#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc_full:focus {
    outline: none;
    border-color: #0078d4;
}

#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc_full.error {
    border-color: #d32f2f;
}

/* 示例按钮样式 */
#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc_visible_expression {
    background-color: #f0f0f0;
    color: #000;
    border: 1px solid #ccc;
    padding: 2px 12px;
...
#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc_visible_expression:hover {
    background-color: #e6e6e6;
}

/* 分组框样式 */
#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc_Box {
    background-color: #fafafa;
    border: 1px solid #e8e8e8;
    border-radius: 4px;
    padding: 8px;
...
/* 分组标题样式 */
#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc_title {
    font-size: 13px;
    font-weight: 500;
    color: #000;
    margin: 0 0 6px 0;
...
/* 单选框组样式 */
#dcPanelBody.InsertMultipleCheckBoxOrRadio .IsRadioBox .dcBody-content {
    display: flex;
    gap: 24px;
    margin-bottom: 0;
}

#dcPanelBody.InsertMultipleCheckBoxOrRadio .IsRadioBox label {
    display: flex;
    align-items: center;
    gap: 0;
    margin: 0;
...
#dcPanelBody.InsertMultipleCheckBoxOrRadio .IsRadioBox label input[type="radio"] {
    width: 14px;
    height: 14px;
    accent-color: #0078d4;
}
...
/* 下拉框样式 */
#dcPanelBody.InsertMultipleCheckBoxOrRadio select.dc_full {
    padding: 4px 8px;
    border: 1px solid #ccc;
    border-radius: 3px;
    font-size: 12px;
...
#dcPanelBody.InsertMultipleCheckBoxOrRadio select.dc_full:focus {
    outline: none;
    border-color: #0078d4;
}

/* 复选框网格布局 */
#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc_checkboxs {
    display: flex;
    gap: 0 10px;
    padding: 0;
    margin: 0;
...
#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc_checkboxs label {
    display: flex;
    align-items: center;
    margin: 0;
}

#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc_checkboxs label input[type="checkbox"] {
    width: 14px;
    height: 14px;
    accent-color: #0078d4;
}

#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc_checkboxs label span {
    font-size: 12px;
    color: #000;
    cursor: pointer;
    user-select: none;
...
/* 数据源区域样式 */
#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc_tab3Content {
    margin-top: 6px;
}
...
#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc_tab3Content label:last-child {
    margin-bottom: 0;
}
...
#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc_tab3Content input:focus {
    outline: none;
    border-color: #0078d4;
}

/* 表格容器样式 */
#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc_scroll-table {
    border-collapse: collapse;
    font-size: 12px;
    width: 100%;
    margin: 6px 0 0 0;
...
/* 表格单元格样式 */
#dcPanelBody.InsertMultipleCheckBoxOrRadio #dc_ListItems td {
    border: 1px solid #ccc;
    padding: 0;
    text-align: center;
}
...
#dcPanelBody.InsertMultipleCheckBoxOrRadio #dc_ListItems td input:focus {
    outline: 1px solid #0078d4;
    background-color: #f0f8ff;
}
...
#dcPanelBody.InsertMultipleCheckBoxOrRadio #dc_ListItems td.dc_delete:hover {
    background-color: #ffebee;
    color: #d32f2f;
}
...
/* 错误状态样式 */
#dcPanelBody.InsertMultipleCheckBoxOrRadio .error-message {
    color: #d32f2f;
    font-size: 11px;
    margin-top: 4px;
    display: block;
...
#dcPanelBody.InsertMultipleCheckBoxOrRadio input.error {
    border: 1px solid #d32f2f !important;
    background-color: #ffebee !important;
}

/* 表格内错误输入框样式 */
#dcPanelBody.InsertMultipleCheckBoxOrRadio #dc_ListItems td input.error {
    border: none !important;
    background-color: #ffebee !important;
    outline: 1px solid #d32f2f !important;
}

/* 错误提示文本样式 */
#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc-error-tip {
    color: #d32f2f;
    font-size: 11px;
    margin-top: 4px;
    display: block;
...
/* 数据分区样式 */
#dcPanelBody.InsertMultipleCheckBoxOrRadio .data-section {
    margin-top: 6px;
    padding-top: 6px;
}

/* 滚动条样式 */
#dcPanelBody.InsertMultipleCheckBoxOrRadio ::-webkit-scrollbar {
    width: 8px;
    height: 8px;
}

#dcPanelBody.InsertMultipleCheckBoxOrRadio ::-webkit-scrollbar-track {
    background-color: #f1f1f1;
    border-radius: 4px;
}

#dcPanelBody.InsertMultipleCheckBoxOrRadio ::-webkit-scrollbar-thumb {
    background-color: #ccc;
    border-radius: 4px;
}

#dcPanelBody.InsertMultipleCheckBoxOrRadio ::-webkit-scrollbar-thumb:hover {
    background-color: #999;
}

/* 添加行按钮样式 */
#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc-add-row-btn {
    margin-top: 10px;
    background-color: #f0f0f0;
    color: #000;
    border: 1px solid #ccc;
...
#dcPanelBody.InsertMultipleCheckBoxOrRadio .dc-add-row-btn:hover {
    background-color: #e6e6e6;
    border-color: #999;
}
...
#dcPanelBody.InputFieldElement .dc_InputFieldContent label,
#dcPanelBody.InputFieldElement .dc_InputFieldContent label>input,
#dcPanelBody.InputFieldElement .dc_InputFieldContent label>select,
#dcPanelBody.InputFieldElement .dc_InputFieldContent label>button,
#dcPanelBody.InputFieldElement .dc_InputFieldContent label>p,
#dcPanelBody.InputFieldElement .dc_InputFieldContent .dc_dc_Check_box_label,
#dcPanelBody.InputFieldElement .dc_InputFieldContent .dc_dropDownList_formbox_label,
#dcPanelBody.InputFieldElement .dc_InputFieldContent .dc_dropDownList_formbox_label>input,
#dcPanelBody.InputFieldElement .dc_InputFieldContent .dc_dropDownList_formbox_label>select {
    font-size: 12px !important;
    padding: 4px 8px !important;
}
#dcPanelBody.InputFieldElement .dc_Box{
    margin-top: 10px;
}
...
#dcPanelBody.InputFieldElement .dc_InputFieldContent label>span {
    font-size: 12px;
    width: 100px;
}
...
#dc_tab3 .dc_Box.dc_changeDisabled.dc_changeDisabled_BinaryLength{
    display: flex;
    flex-direction: column;
}
...
#dc_dialogContainer #dc_tab3 .dc_ValidateStyle_label_item {
    width: 100%;
    margin-bottom: 8px;
    display: flex;
    align-items: center;
}
#dc_dialogContainer #dc_tab3 .dc_ValidateStyle_label_item span{
    font-size: 12px;
    width: 100px;
}
...
#dc_dialogContainer #dc_tab3 .dc_ValidateStyle_label{
    display: flex;
}
...
#dcPanelBody.InputFieldElement .dc_InputFieldContent .dc_tab1Content>label.dc_SpecifyWidth_label{
    width:100%;
}
...
#dcPanelBody.InputFieldElement .dc_InputFieldContent .dc_tab2Content .dc_tab2Content_label_inp:focus {
    outline: none;
    border-color: #0078d4;
}
...
#dcPanelBody.InputFieldElement .dc_InputFieldContent .dc_tab3Content>label>input:focus,
#dcPanelBody.InputFieldElement .dc_InputFieldContent .dc_tab3Content>label>select:focus {
    outline: none;
    border-color: #0078d4;
}
...
#dcPanelBody.InputFieldElement .dc_InputFieldContent #dc_tab2 .dc_tab2-radio-ipt-label{
    display: flex;
    align-items: center;
}
#dcPanelBody.InputFieldElement .dc_InputFieldContent #dc_tab2 .dc_tab2-radio-ipt-label .dc_tab2-radio-ipt{
    margin-right: 10px;
}
...
#dcPanelBody.InputFieldElement .dc_InputFieldContent #dc_tab2 .dc_Check-box {
    ...
    #dcPanelBody.InputFieldElement .dc_InputFieldContent #dc_tab2  #dc_dropDownList_formbox .dc_dc_Check_box_label{
        width: 100%;
    }
    #dcPanelBody.InputFieldElement .dc_InputFieldContent #dc_tab2  #dc_dropDownList_formbox .dc_dc_Check_box_label{
        width: 100%;
    }
#dcPanelBody.InputFieldElement .dc_InputFieldContent #dc_tab2  #dc_dropDownList_formbox .dc_dropDownList_formbox_label{
    display: flex;
    align-items: center;
    // margin-top: 10px !important;
}
#dcPanelBody.InputFieldElement .dc_InputFieldContent #dc_tab2  #dc_dropDownList_formbox .dc_dropDownList_formbox_label span{
    width: 120px;
}
...
#dcPanelBody.InputFieldElement .dc_InputFieldContent #dc_tab3{
    // padding-top:20px;
}
#dcPanelBody.InputFieldElement .dc_InputFieldContent #tab3>label {
    margin-bottom: 16px;
}
#dcPanelBody.InputFieldElement .dc_InputFieldContent #dc_tab4{
    // padding-top:20px;
}
...
/* 输入域属性-移动端属性 */
#dcPanelBody.InputFieldElement .dc_mobile_attributes_box{
    display: flex;
   flex-wrap: wrap;
}
#dc_dialogContainer #dcPanelBody.InputFieldElement .dc_mobile_attributes_box label{
    width: 50%;
    margin-bottom: 10px;
    display: flex;
...
#dc_dialogContainer #dcPanelBody.InputFieldElement .dc_mobile_attributes_box label span {
    width:134px;
    text-align: right;
}

#dc_dialogContainer #dcPanelBody.InputFieldElement .dc_mobile_attributes_box label select,
#dc_dialogContainer #dcPanelBody.InputFieldElement .dc_mobile_attributes_box label input {
    width: 150px;
}
#dc_dialogContainer #dcPanelBody.InputFieldElement .dc_mobile_attributes_box label.dc_mobile_attributes_box_item_hide{
    display:none;
}


#dc_dialogContainer #dcPanelBody.InputFieldElement #dc_mobile_event_box .dc_mobile_event_item {
    width: 100%;
    display: flex;
    align-items: center;
    box-sizing: border-box;
...
#dc_dialogContainer #dcPanelBody.InputFieldElement #dc_mobile_event_box .dc_mobile_event_item span {
    flex: 1;
    border: 1px solid #ccc;
    margin: 0;
    padding: 10px;
...
#dc_dialogContainer #dcPanelBody.InputFieldElement #dc_mobile_event_box .dc_mobile_event_item .dc_mobile_event_item_edit{
    cursor: pointer;
}
#dc_dialogContainer #dcPanelBody.InputFieldElement #dc_mobile_event_box .dc_mobile_event_item .dc_mobile_event_item_edit:hover{
    color: #1890ff;
    background: #f5f5f5;
}

#dc_dialogContainer #dcPanelBody.InputFieldElement .dc_mobile_attributes_box_item_readonly{
    background: #fff;
    width: 150px;
    line-height: normal;
    border: 1px solid #d9d9d9;
...
.dc_mobile_event_dialog_title {
    font-size: 16px;
    font-weight: 500;
    color: #303133;
    margin: 0;
}
.dc_mobile_event_dialog_close {
    width: 24px;
    height: 24px;
    line-height: 24px;
    text-align: center;
...
.dc_mobile_event_dialog_close:hover {
    color: #409eff;
}
.dc_mobile_event_dialog_content {
    flex: 1;
    overflow-y: auto;
    padding: 0;
    display: flex;
...
.dc_mobile_event_dialog_editor_wrapper {
    flex: 1;
    padding: 20px;
    min-height: 300px;
    background-color: #fff;
}
.dc_mobile_event_dialog_editor {
    width: 100%;
    height: 100%;
    min-height: 300px;
    padding: 10px;
...
.dc_mobile_event_dialog_editor:focus {
    outline: none;
    border-color: #409eff;
}
.dc_mobile_event_dialog_footer {
    display: flex;
    justify-content: flex-end;
    align-items: center;
    padding: 20px;
...
.dc_mobile_event_dialog_btn_confirm {
    background-color: #409eff;
    color: #fff;
    border-color: #409eff;
}
.dc_mobile_event_dialog_btn_confirm:hover {
    background-color: #66b1ff;
    border-color: #66b1ff;
}
.dc_mobile_event_dialog_btn_cancel {
    background-color: #fff;
    color: #606266;
    border-color: #dcdfe6;
}
.dc_mobile_event_dialog_btn_cancel:hover {
    color: #409eff;
    border-color: #409eff;
}
...
*表格列宽度属性对话框
*/
#dcPanelBody.dc_tableColumnWidth .dc_tableColumnWidth_title {
    display: block;
    margin-bottom: 8px;
    text-align: left;
    color: #666;
...
#dcPanelBody.dc_tableColumnWidth #dc_ColumnWidth {
    width: 100%;
    padding: 10px 12px;
    font-size: 16px;
    border: 1px solid #d9d9d9;
...
#dcPanelBody.dc_tableColumnWidth .dc_tableColumnWidth_tips {
    font-size: 12px;
    color: #999;
    text-align: left;
    margin-top: 6px;
...
#dc_dialogContainer #dcPanelBody .dc_attribute_dialog_table_box{
    border: 2px solid #ccc;
    margin-bottom: 12px;
}
#dc_dialogContainer #dcPanelBody .dc_attribute_dialog_box {
    background-color: transparent;
    border: none;
    padding: 0;
    margin: 0;
...
#dc_dialogContainer #dcPanelBody  .dc_attribute_dialog_title {
    display: flex;
    justify-content: flex-end;
    gap: 8px;
    margin-bottom: 8px;
...
#dc_dialogContainer #dcPanelBody  .dc_attribute_dialog_title span {
    background-color: #f0f0f0;
    color: #000;
    border: 1px solid #ccc;
    padding: 4px 12px;
...
#dc_dialogContainer #dcPanelBody  .dc_attribute_dialog_title span:hover {
    background-color: #e6e6e6;
}

#dc_dialogContainer #dcPanelBody  #dc_attr-table-box {
    width: 100%;
    border-collapse: collapse;
    font-size: 12px;
    background-color: white;
...
#dc_dialogContainer #dcPanelBody #dc_attr-table-box th {
    background-color: #f0f0f0;
    border: 1px solid #ccc;
    padding: 8px 6px;
    text-align: center;
...
#dc_dialogContainer #dcPanelBody #dc_attr-table-box td {
    border: 1px solid #ccc;
    padding: 4px 6px;
    text-align: center;
}

#dc_dialogContainer #dcPanelBody #dc_attr-table-box td.dc_delete-button {
    cursor: pointer;
    color: #666;
    font-size: 14px;
    transition: all 0.2s;
...
#dc_dialogContainer #dcPanelBody #dc_attr-table-box td.dc_delete-button:hover {
    background-color: #ffebee;
    color: #d32f2f;
}

#dc_dialogContainer #dcPanelBody #dc_attr-table-box input {
    width: 100%;
    border: none;
    padding: 4px 6px;
    font-size: 12px;
...
#dc_dialogContainer #dcPanelBody #dc_attr-table-box input:focus {
    background-color: #f0f8ff;
    outline: 1px solid #0078d4;
}
...
#dc_dialogContainer #dcPanelBody .dc_ons-2 {
    width: 40%;
}

#dc_dialogContainer #dcPanelBody .dc_ons-3 {
    width: 45%;
}

#dc_dialogContainer #dcPanelBody .dc_ons-4 {
    width: 15%;
}

#dc_dialogContainer #dcPanelBody .dc_add_attr_button {
    margin-top: 8px;
    background-color: #f0f0f0;
    color: #000;
    border: 1px solid #ccc;
...
#dc_dialogContainer #dcPanelBody .dc_add_attr_button:hover {
    background-color: #e6e6e6;
    border-color: #999;
}
 ...
 *复合牙位图
 */
#dcPanelBody .dc_ManyValues_content {
    width: 100%;
    display: flex;
}

#dcPanelBody .dc_ManyValues_Left {
    width: 50%;
    border-right: 1px solid #000000;
}

#dcPanelBody .dc_ManyValues_Right {
    flex: 1;
    border-left: 1px solid #000000;
}

.dc_ManyValues_Left_top_number ,
.dc_ManyValues_Left_top_text,
.dc_ManyValues_Left_bottom_text,
.dc_ManyValues_Left_bottom_number{
    display: flex;
    justify-content: flex-end;
    padding-right: 4px;
}
.dc_ManyValues_Right_top_number ,
.dc_ManyValues_Right_top_text,
.dc_ManyValues_Right_bottom_text,
.dc_ManyValues_Right_bottom_number{
    display: flex;
    justify-content: flex-start;
    padding-left: 4px;
}
...
#dcPanelBody .dc_many_values_tooth{
    width: 28px;
    height: 28px;
    border: 1px solid #000;
    text-align: center;
...
#dcPanelBody .dc_many_values_tooth.dc_many_values_tooth_active{
    background-color: #000000;
    color: #fff;
}

#dcPanelBody .dc_ManyValues_Left_Line {
    width: 100%;
    height: 1px;
    border-bottom: 2px solid #000;
}

#dcPanelBody .dc_ManyValues_Right_Line {
    width: 100%;
    height: 1px;
    border-bottom: 2px solid #000;
}
...
/* 边框和底纹 */
#dc_dialogContainer #dcPanelBody.BorderPattern{
    padding: 0;
}
.dc_border_pattern_dialog-container {
    background-color: white;
    border-radius: 8px;
    width: 700px;
    max-height: 90vh;
    ...
    display: flex;
    flex-direction: column;
    animation: dc_border_pattern_modalFadeIn 0.3s ease-out;
}

@keyframes dc_border_pattern_modalFadeIn {
    from {
        opacity: 0;
...
/* 对话框标题栏 */
.dc_border_pattern_dialog-content {
    height: 100%;
    overflow: hidden;
    display: flex;
    flex-direction: column;
...
#dc_border_pattern_borderTab {
    flex: 1;
    overflow: hidden;
}

.dc_border_pattern_dialog-header {
    background-color: white;
    color: #000;
    padding: 14px 20px;
    font-size: 16px;
...
.dc_border_pattern_dialog-title {
    font-weight: 600;
}

.dc_border_pattern_close-button {
    background: none;
    border: none;
    color: #999;
    font-size: 18px;
...
.dc_border_pattern_close-button:hover {
    background-color: #f5f5f5;
    color: #000;
}

.dc_border_pattern_close-button:active {
    background-color: #e6e6e6;
}
...
/* 选项卡 */
.dc_border_pattern_tab-container {
    display: flex;
    border-bottom: 1px solid #f0f0f0;
    background-color: #fafafa;
}

.dc_border_pattern_tab {
    padding: 10px 20px;
    background-color: transparent;
    border: none;
    border-bottom: 2px solid transparent;
...
.dc_border_pattern_tab.active {
    background-color: white;
    border-bottom-color: #1890ff;
    color: #1890ff;
}

.dc_border_pattern_tab:hover {
    color: #1890ff;
}

/* 选项卡内容 */
.dc_border_pattern_tab-content {
    display: none;
}

.dc_border_pattern_tab-content.active {
    display: block;
}

/* 边框选项卡内容 */
.dc_border_pattern_border-section {
    display: flex;
    gap: 20px;
    height: 100%;
    padding: 20px;
...
table#dc_border_pattern_borderPreviewTable {
    width: 100px;
    box-sizing: border-box;
    border-radius: 0;
    border: 0;
...
.dc_border_pattern_border-right {
    flex: 1;
    display: flex;
    flex-direction: column;
}
...
/* 设置区域 */
.dc_border_pattern_setting-group {
    margin-bottom: 0;
    display: flex;
    flex-direction: column;
    gap: 6px;
...
.dc_border_pattern_setting-title {
    font-size: 12px;
    font-weight: 500;
    margin-bottom: 3px;
    color: #000;
...
/* 边框样式选项 */
.dc_border_pattern_border-style-options {
    display: flex;
    flex-direction: column;
    gap: 4px;
}

.dc_border_pattern_border-style-option {
    display: flex;
    align-items: center;
    padding: 5px 8px;
    cursor: pointer;
...
.dc_border_pattern_border-style-option:hover {
    background-color: #e6f7ff;
    border-color: #1890ff;
}

.dc_border_pattern_border-style-option.dc_border_pattern_selected {
    background-color: #1890ff;
    color: white;
    border-color: #1890ff;
}

.dc_border_pattern_border-style-icon {
    width: 24px;
    height: 20px;
    border: 1px solid #d9d9d9;
    background-color: white;
...
.dc_border_pattern_border-style-option.dc_border_pattern_selected .dc_border_pattern_border-style-icon {
    border-color: white;
    background-color: rgba(255, 255, 255, 0.9);
}

/* 线型选择 */
.dc_border_pattern_line-style-container {
    border: 1px solid #d9d9d9;
    background-color: white;
    max-height: 150px;
    overflow-y: auto;
...
.dc_border_pattern_line-style-option {
    display: flex;
    align-items: center;
    padding: 5px 8px;
    cursor: pointer;
...
.dc_border_pattern_line-style-option:last-child {
    border-bottom: none;
}

.dc_border_pattern_line-style-option:hover {
    background-color: #e6f7ff;
}

.dc_border_pattern_line-style-option.dc_border_pattern_selected {
    background-color: #1890ff;
    color: white;
}
...
/* 宽度容器样式 */
.dc_border_pattern_width-container {
    display: flex;
    align-items: center;
    gap: 8px;
}
...
.dc_border_pattern_width-input:focus {
    outline: none;
    border-color: #1890ff;
    box-shadow: 0 0 0 2px rgba(24, 144, 255, 0.2);
}

.dc_border_pattern_width-input:hover {
    border-color: #40a9ff;
}

.dc_border_pattern_width-unit {
    font-size: 12px;
    color: #666;
    font-weight: 500;
}
...
/* 颜色选择器 */
.dc_border_pattern_color-picker-group {
    display: flex;
    align-items: center;
    gap: 6px;
}

.dc_border_pattern_color-preview {
    width: 24px;
    height: 24px;
...
.dc_border_pattern_color-preview:hover {
    border-color: #1890ff;
    transform: scale(1.1);
...
/* 隐藏的颜色输入框 - 定位在预览块上 */
.dc_border_pattern_color-input-hidden {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
...
/* 预览区域 */
.dc_border_pattern_preview-section {
    background-color: #fafafa;
    padding: 20px;
    border-radius: 4px;
    text-align: center;
...
.dc_border_pattern_preview-title {
    font-size: 12px;
    font-weight: 500;
    margin-bottom: 6px;
    color: #000;
...
.dc_border_pattern_preview-instruction {
    font-size: 11px;
    color: #666;
    margin-bottom: 12px;
}

.dc_border_pattern_preview-area {
    width: 100%;
    height: 266px;
    border: 1px solid #d9d9d9;
    background-color: white;
...
.dc_border_pattern_preview-container {
    display: flex;
    flex-direction: column;
    align-items: center;
    justify-content: center;
...
.dc_border_pattern_preview-table-container {
    display: flex;
    align-items: center;
}

/* 底部横向排列的竖线按钮 */
.dc_border_pattern_preview-bottom-row {
    width: calc(100% - 30px);
    display: flex;
    flex-direction: row;
...
/* 左侧纵向排列的横线按钮 */
.dc_border_pattern_preview-left-column {
    width: 30px;
    height: 80px;
    display: flex;
    flex-direction: column;
...
/* 左侧按钮精确定位 - 与表格边框线对齐 */
.dc_border_pattern_preview-left-column .dc_border_pattern_preview-button:nth-child(1) {
    margin-bottom: 0px; /* 上边框按钮 */
}
.dc_border_pattern_preview-left-column .dc_border_pattern_preview-button:nth-child(2) {
    margin-top: 20px; /* 内部水平线按钮 - 与表格中间线对齐 */
}
.dc_border_pattern_preview-left-column .dc_border_pattern_preview-button:nth-child(3) {
    margin-top: 20px; /* 下边框按钮 - 与表格底边对齐 */
}


.dc_border_pattern_preview-table {
    width: 80px;
    height: 60px;
    border-collapse: collapse;
    background-color: white;
...
.dc_border_pattern_preview-table td {
    width: 60px;
    height: 40px;
    border: 1px solid #d9d9d9;
    text-align: center;
...
.dc_border_pattern_preview-button {
    width: 24px;
    height: 24px;
    border: 1px solid #d9d9d9;
    background-color: white;
...
.dc_border_pattern_preview-button:hover {
    background-color: #e6f7ff;
    border-color: #1890ff;
}

.dc_border_pattern_preview-button.active {
    background-color: #1890ff;
    color: white;
    border-color: #1890ff;
}
...
/* 页面边框按钮容器 */
.dc_border_pattern_page-border-buttons {
    display: flex;
    justify-content: center;
    align-items: center;
    gap: 8px;
...
/* 页面边框按钮 */
.dc-dialog-container .dc_border_pattern_page-border-btn {
    min-width: 50px;
    height: 28px;
    padding: 0;
    border: 1px solid #d9d9d9;
...
.dc_border_pattern_page-border-btn:hover {
    background-color: #e6f7ff;
    border-color: #1890ff;
    color: #1890ff;
}

.dc_border_pattern_page-border-btn.active {
    background-color: #1890ff;
    color: white;
    border-color: #1890ff;
}
...
/* 应用于设置 */
.dc_border_pattern_apply-to-group {
    display: flex;
    align-items: center;
    gap: 8px;
    margin-top: 12px;
...
.dc_border_pattern_apply-to-label {
    font-size: 12px;
    color: #000;
    font-weight: 500;
}

.dc_border_pattern_apply-to-select {
    padding: 4px 6px;
    border: 1px solid #d9d9d9;
    background-color: white;
    font-size: 12px;
...
.dc_border_pattern_apply-to-select:focus {
    outline: none;
    border-color: #1890ff;
    box-shadow: 0 0 0 2px rgba(24, 144, 255, 0.2);
}

.dc_border_pattern_apply-to-select:hover {
    border-color: #40a9ff;
}

.dc_border_pattern_options-button {
    padding: 5px 10px;
    border: 1px solid #d9d9d9;
    background-color: white;
    font-size: 12px;
...
.dc_border_pattern_options-button:hover {
    background-color: #f0f0f0;
    border-color: #40a9ff;
}

.dc_border_pattern_options-button:active {
    background-color: #e6e6e6;
}

/* 底纹选项卡内容 */
.dc_border_pattern_shading-section {
    display: flex;
    gap: 20px;
    height: 450px;
    padding: 20px;
...
.dc_border_pattern_shading-left {
    flex: 1;
    display: flex;
    flex-direction: column;
    gap: 16px;
...
.dc_border_pattern_shading-right {
    flex: 1;
    display: flex;
    flex-direction: column;
}

.dc_border_pattern_color-grid {
    display: grid;
...
.dc_border_pattern_color-option {
    width: 24px;
    height: 24px;
    border: 2px solid #d9d9d9;
    cursor: pointer;
...
.dc_border_pattern_color-option:hover {
    border-color: #1890ff;
    transform: scale(1.1);
    box-shadow: 0 2px 6px rgba(24, 144, 255, 0.3);
}

.dc_border_pattern_color-option.dc_border_pattern_selected {
    border: 3px solid #1890ff;
    box-shadow: 0 0 0 2px rgba(24, 144, 255, 0.2);
}

/* 自定义颜色选项 */
.dc_border_pattern_custom-color-option {
    display: flex;
    align-items: center;
    justify-content: center;
...
.dc_border_pattern_custom-color-option:hover {
    background: linear-gradient(135deg, #e6f7ff 0%, #bae7ff 100%);
    border-color: #1890ff !important;
}

.dc_border_pattern_custom-color-option span {
    font-weight: bold;
}

/* 当前颜色显示 */
.dc_border_pattern_current-color-display {
    margin-top: 16px;
    padding: 12px;
    background-color: #fafafa;
    border: 1px solid #e0e0e0;
...
.dc_border_pattern_current-color-label {
    font-size: 12px;
    font-weight: 500;
    color: #000;
    margin-bottom: 8px;
...
.dc_border_pattern_current-color-info {
    display: flex;
    align-items: center;
    gap: 12px;
}

.dc_border_pattern_current-color-preview {
    width: 48px;
    height: 48px;
    border: 2px solid #d9d9d9;
    border-radius: 4px;
...
.dc_border_pattern_current-color-value {
    font-size: 14px;
    font-weight: 600;
    color: #000;
...
/* 页面边框选项卡内容 */
.dc_border_pattern_page-border-section {
    display: flex;
    gap: 20px;
    height: 100%;
    padding: 20px;
...
.dc_border_pattern_page-border-left {
    flex: 1;
    display: flex;
    flex-direction: column;
    gap: 16px;
...
.dc_border_pattern_page-border-right {
    flex: 1;
    display: flex;
    flex-direction: column;
}
...
/* 对话框底部 */
.dc_border_pattern_dialog-footer {
    padding: 14px 20px;
    border-top: 1px solid #f0f0f0;
    background-color: white;
    display: flex;
...
.dc_border_pattern_footer-left {
    display: flex;
    align-items: center;
    gap: 8px;
}

.dc_border_pattern_help-link {
    font-size: 12px;
    color: #1890ff;
    text-decoration: none;
    cursor: pointer;
...
.dc_border_pattern_help-link:hover {
    background-color: #e6f7ff;
}

.dc_border_pattern_footer-right {
    display: flex;
    gap: 12px;
}

.dc_border_pattern_dialog-button {
    padding: 5px 16px;
    border: none;
    cursor: pointer;
    font-size: 13px;
...
.dc_border_pattern_btn-ok {
    background-color: #1890ff;
    color: white;
    border: 1px solid #1890ff;
}

.dc_border_pattern_btn-ok:hover {
    background-color: #40a9ff;
}

.dc_border_pattern_btn-ok:active {
    background-color: #096dd9;
}

.dc_border_pattern_btn-cancel {
    background-color: #f0f0f0;
    color: #000;
    border: 1px solid #d9d9d9;
}

.dc_border_pattern_btn-cancel:hover {
    background-color: #e6e6e6;
}

.dc_border_pattern_btn-cancel:active {
    background-color: #d9d9d9;
}

/* 复选框样式 */
.dc_border_pattern_checkbox-item {
    display: flex;
    align-items: center;
    gap: 6px;
    cursor: pointer;
...
.dc_border_pattern_checkbox-input {
    width: 14px;
    height: 14px;
    accent-color: #1890ff;
    cursor: pointer;
...
.dc_border_pattern_checkbox-label {
    font-size: 12px;
    color: #000;
    cursor: pointer;
}
...
/* 单选框样式 */
.dc_border_pattern_radio-group {
    display: flex;
    gap: 16px;
}

.dc_border_pattern_radio-item {
    display: flex;
    align-items: center;
    gap: 6px;
    cursor: pointer;
...
/* 单独边框颜色网格 */
.dc_border_pattern_individual-color-grid {
    display: grid;
...
.dc_border_pattern_border-direction-label {
    font-size: 11px;
    color: #666;
    font-weight: 500;
}

.dc_border_pattern_border-color-preview-mini {
    width: 24px;
    height: 24px;
    border-radius: 4px;
    border: 2px solid #d9d9d9;
...
.dc_border_pattern_border-color-preview-mini:hover {
...
.dc_border_pattern_hidden {
    display: none;
}

/* 滚动条美化 */
.dc_border_pattern_border-left::-webkit-scrollbar,
.dc_border_pattern_shading-left::-webkit-scrollbar,
.dc_border_pattern_page-border-left::-webkit-scrollbar,
.dc_border_pattern_line-style-container::-webkit-scrollbar {
    width: 6px;
}

.dc_border_pattern_border-left::-webkit-scrollbar-track,
.dc_border_pattern_shading-left::-webkit-scrollbar-track,
.dc_border_pattern_page-border-left::-webkit-scrollbar-track,
.dc_border_pattern_line-style-container::-webkit-scrollbar-track {
    background-color: #f0f0f0;
}

.dc_border_pattern_border-left::-webkit-scrollbar-thumb,
.dc_border_pattern_shading-left::-webkit-scrollbar-thumb,
.dc_border_pattern_page-border-left::-webkit-scrollbar-thumb,
.dc_border_pattern_line-style-container::-webkit-scrollbar-thumb {
    background-color: #bfbfbf;
    border-radius: 3px;
}

.dc_border_pattern_border-left::-webkit-scrollbar-thumb:hover,
.dc_border_pattern_shading-left::-webkit-scrollbar-thumb:hover,
.dc_border_pattern_page-border-left::-webkit-scrollbar-thumb:hover,
.dc_border_pattern_line-style-container::-webkit-scrollbar-thumb:hover {
    background-color: #999;
}
...
@media (max-width: 750px) {
    ...
    .dc_border_pattern_preview-buttons {
        gap: 6px;
    }
...
#dc_border_pattern_unifiedColorRow,
#dc_border_pattern_individualColorRows{
    height: 40px;
}
#dc_border_pattern_pageTab{
    flex: 1;
    overflow: hidden;
}
.dc_border_pattern_page-border-left{
...
#dc_dialogContainer #dcPanelBody   #dcMedicalExpression * {
    margin: 0;
    padding: 0;
    box-sizing: border-box;
}
...
#dc_dialogContainer #dcPanelBody   .dc_MedicalExpression_form {
...
#dc_dialogContainer #dcPanelBody  .dc_MedicalExpression_form[style*="display: none"] {
    display: none !important;
}

#dc_dialogContainer #dcPanelBody  .config-title-row {
    display: flex;
    align-items: center;
    justify-content: space-between;
    margin-bottom: 12px;
...
#dc_dialogContainer #dcPanelBody  .config-title {
    font-size: 13px;
    font-weight: 500;
    color: #333;
}

#dc_dialogContainer #dcPanelBody  .config-tip {
    font-size: 11px;
    color: #999;
    white-space: nowrap;
}

#dc_dialogContainer #dcPanelBody  .config-form {
    display: flex;
    flex-direction: column;
    gap: 12px;
}

#dc_dialogContainer #dcPanelBody  .config-row {
    display: flex;
    align-items: center;
    gap: 12px;
    flex-wrap: wrap;
...
#dc_dialogContainer #dcPanelBody  .config-item {
    display: flex;
    align-items: center;
    gap: 6px;
    flex-shrink: 0;
...
#dc_dialogContainer #dcPanelBody   .config-label {
    font-size: 12px;
    color: #333;
    white-space: nowrap;
    flex-shrink: 0;
...
#dc_dialogContainer #dcPanelBody   .config-item.id-item .config-label,
#dc_dialogContainer #dcPanelBody   .config-item.font-item .config-label {
    text-align: right;
    min-width: 50px;
}


#dc_dialogContainer #dcPanelBody   .config-input:focus {
    outline: none;
    border-color: #0078d4;
}

#dc_dialogContainer #dcPanelBody   .config-item.id-item .config-input {
    width: 180px;
    padding: 4px 8px !important;
    border: 1px solid #ccc;
    border-radius: 3px;
...
#dc_dialogContainer #dcPanelBody   .config-item.size-item .config-input {
    width: 50px;
    height: 26px;
}

#dc_dialogContainer #dcPanelBody   .size-inputs-wrapper {
    display: flex;
    align-items: center;
    gap: 4px;
}

#dc_dialogContainer #dcPanelBody   .size-separator {
    font-size: 12px;
    color: #666;
    padding: 0 2px;
}

#dc_dialogContainer #dcPanelBody   .config-item.size-item {
    opacity: 0;
    max-height: 0;
    overflow: hidden;
...
#dc_dialogContainer #dcPanelBody   .config-item.size-item.show {
    opacity: 1;
    max-height: 100px;
}

#dc_dialogContainer #dcPanelBody   .config-item.font-item .config-select {
    width: 140px;
    padding: 4px 8px !important;
    border: 1px solid #ccc;
    border-radius: 3px;
...
#dc_dialogContainer #dcPanelBody  .config-item.font-item  .config-select:focus {
    outline: none;
    border-color: #0078d4;
}

#dc_dialogContainer #dcPanelBody   .config-checkbox {
    width: 14px;
    height: 14px;
    accent-color: #0078d4;
    cursor: pointer;
...
#dc_dialogContainer #dcPanelBody   .config-checkbox-label {
    font-size: 12px;
    color: #333;
    cursor: pointer;
    user-select: none;
...
#dc_dialogContainer #dcPanelBody   .dc_MedicalExpression_type {
    flex: 1;
    display: flex;
    flex-direction: column;
    min-height: 0;
...
#dc_dialogContainer #dcPanelBody   .dc_title {
    font-size: 13px;
    font-weight: 500;
    color: #333;
    margin: 0 0 12px 0;
...
#dc_dialogContainer #dcPanelBody   #MedicalExpressionChooseIMGBox {
    overflow-y: auto;
}

#dc_dialogContainer #dcPanelBody   .dc_MedicalExpressionChooseDiv {
    position: relative;
    cursor: pointer;
    border: 1px solid #e0e0e0;
    border-radius: 4px;
...
#dc_dialogContainer #dcPanelBody   .dc_MedicalExpressionChooseDiv:hover {
    border-color: #0078d4;
    background-color: #f0f8ff;
}

#dc_dialogContainer #dcPanelBody   .dc_MedicalExpressionChooseDiv_active {
    border: 2px solid #0078d4;
    background-color: #e6f3ff;
}

#dc_dialogContainer #dcPanelBody   .dc_MedicalExpressionChooseDiv image {
    width: 2cm;
    height: 1cm;
    margin-bottom: 6px;
    object-fit: contain;
...
#dc_dialogContainer #dcPanelBody   .dc_MedicalExpressionChooseDiv div {
    font-size: 12px;
    color: #333;
    text-align: center;
    font-weight: 500;
...
#dc_dialogContainer #dcPanelBody    #MedicalExpressionChooseIMGBox::-webkit-scrollbar {
    width: 8px;
}

#dc_dialogContainer #dcPanelBody    #MedicalExpressionChooseIMGBox::-webkit-scrollbar-track {
    background-color: #f1f1f1;
    border-radius: 4px;
}

#dc_dialogContainer #dcPanelBody    #MedicalExpressionChooseIMGBox::-webkit-scrollbar-thumb {
    background-color: #ccc;
    border-radius: 4px;
}

#dc_dialogContainer #dcPanelBody   #MedicalExpressionChooseIMGBox::-webkit-scrollbar-thumb:hover {
    background-color: #999;
}

#dc_dialogContainer #dcPanelBody   .dc_MedicalExpression_form_item {
    display: none;
}

#dc_dialogContainer #dcPanelBody  .dc_flex {
    display: flex;
}

#dc_dialogContainer #dcPanelBody   .dc_full {
    flex: 1;
}
#dc_dialogContainer #dcPanelBody   .config-title-row {
    margin-bottom: 10px !important;
...
#dc_dialogContainer #dcPanelBody #dcMedicalExpression .search-section {
    margin-bottom: 16px;
    flex-shrink: 0;
}
#dc_dialogContainer #dcPanelBody #dcMedicalExpression .search-wrapper {
    position: relative;
    margin-bottom: 8px;
}
#dc_dialogContainer #dcPanelBody #dcMedicalExpression .search-input {
    width: 100%;
...
#dc_dialogContainer #dcPanelBody  #dcMedicalExpression .search-input:focus {
    outline: none;
    border-color: #0078d4;
}
#dc_dialogContainer #dcPanelBody  #dcMedicalExpression .search-icon {
    position: absolute;
    right: 10px;
    top: 50%;
    transform: translateY(-50%);
...
#dc_dialogContainer #dcPanelBody   #dcMedicalExpression .category-tabs {
    display: flex;
    gap: 8px;
    flex-wrap: wrap;
}
#dc_dialogContainer #dcPanelBody  #dcMedicalExpression .category-tab {
    padding: 6px 14px;
    border: 1px solid #ddd;
    border-radius: 4px;
    background-color: white;
...
#dc_dialogContainer #dcPanelBody  #dcMedicalExpression .category-tab:hover {
    background-color: #f5f5f5;
}
#dc_dialogContainer #dcPanelBody  #dcMedicalExpression .category-tab.active {
    background-color: #0078d4;
    color: white;
    border-color: #0078d4;
}
#dc_dialogContainer #dcPanelBody  #dcMedicalExpression .empty-message {
    text-align: center;
    color: #999;
    font-size: 12px;
    padding: 40px 20px;
}
#dc_dialogContainer #dcPanelBody  #dcMedicalExpression .empty-message.hidden {
    display: none;
}
`,
    //线的样式列表
    ...
    //罗马字符
    ROMANCHARACTERS: ["ⅰ", "ⅱ", "ⅲ", "ⅳ", "ⅴ", "ⅵ", "ⅶ", "ⅷ", "ⅸ", "ⅹ", "Ⅰ", "Ⅱ", "Ⅲ", "Ⅳ", "Ⅴ", "Ⅵ", "Ⅶ", "Ⅷ", "Ⅸ", "Ⅹ",
        "Ⅺ", "Ⅻ"],
    ...
    MOCKARRAY: [
        ...
        // { name: 'BorderPatternDialog', description: "边框和底纹" },
        { name: 'BorderBackgroundFormat', description: "边框和底纹" },
        ...
        { name: 'DocumentSettingsDialog', description: "页面设置" },
        ...
        { name: 'TableColumnWidthProperties', description: "表格列宽属性对话框" },
    ...
    DCEXECUTECOMMANDDEFAULTOPTIONS: {
        ...
        FontName: "楷体",
        FontSize: "20",
        insertxml: `<XTextDocument xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" EditorVersionString="2024.8.20.0">
