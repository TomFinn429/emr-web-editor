...
export let TemperatureControl_Designer = {
    ...
    initDesignerDiv: function (rootElement, xml) {
        ...
        if (CreateTemperatureControlForWASM) {
            ...
            DesignerRootElement.EventStructureClick = function (control, StructureInfo, type) {
                ...
                CurrentDesignerElement && CurrentDesignerElement.scrollIntoView();
            };
    ...
    */
    CreatDesignerPropertyDom: function (attrId = null) {
        ...
        //当前数据的属性类型
        var attrType = null;
        var attrDome = designerDiv.querySelector(`span[attr-id="${attrId}"]`);
        if (attrDome && attrDome.getAttribute('attr-type')) {
            attrType = attrDome && attrDome.getAttribute('attr-type');
        } else {
            attrType = 'document';
        }
        ...
        //获取属性值渲染页面
        var prop = (attrType == 'document' ? rootElementDesigner.GetDocumentConfigProperties() : rootElementDesigner.GetInternalProperties(attrId, attrType));
   ...
   */
    ...
    */
    DCDesignerDocumentObjectCN: {
        ...
        "UpAndDownTextTypeDisplay": "上下文本类型显示方式",
        "TitleAlign": "标题对齐",
...
var DCDesignerDocumentObject = {
    ...
    YAxisInfos: {
        ...
        SymbolStyle: {
            type: 'select',
            options: ['SolidCicle', 'HollowCicle', 'Cross', 'SolidTriangle', 'SolidTriangleReversed', "HollowSquare", "P"]
            // : ["SolidCicle",
            //     "Cross",
            //     // "RoundDotIcon",
            //     "SolidTriangle",
    ...
    HeaderLines: {
        ...
        UpAndDownTextTypeDisplay: {
            type: 'select',
            options: ["FirstValueIsAbove", "FirstValueIsBelow"]
        },
        TitleAlign: {
            type: 'select',
