(() => {
    ...
    class Ft {
        ...
        loadResourceWithoutCaching(e, t, n, r) {
            if (this.startOptions.loadBootResource) {
                ...
                if (o != null && o.constructor.name === 'Promise') return o;
                "string" == typeof o && (t = o)
            }
            return fetch(t, {
                cache: "no-cache",
    ...
    Ke.start = Vt, document && document.currentScript && document.currentScript.getAttribute("autostart") && "false" !== document.currentScript.getAttribute("autostart") && Vt().catch((e => {
