...
export let TemperatureControl_Data = {
    ...
    NewTitleLine: function () {
        ...
        line.UpAndDownTextType = "None";//上下交替文本样式"None""ShowByTick""ShowByText" "FirstValueIsBelow"     //适配
        line.UpAndDownTextTypeDisplay = "FirstValueIsBelow";//上下交替文本样式"FirstValueIsBelow"显示第一个值在下方  "FirstValueIsAbove"显示第一个值在上方    //适配
